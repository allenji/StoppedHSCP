...
def MakeCompareHaloJetEnergy(inputFile,inputFile2,legend1,legend2,livetime1,livetime2,output):
...
#inputFile2 = "/home/weifengji/testV2/processDataAnalysis/CMSSW_7_4_5_ROOT5/src/histos0T/histograms.root"
  ...
  canvas = rt.TCanvas("cHaloE","cHaloE",50,50,W,H)
  ...
  h1 = file.Get("halo/hhalojete")
  file2 = rt.TFile(inputFile2, "READ")
  h2 = file2.Get("halo/hhalojete")
  h2.SetLineColor(2)
  ...
  canvas.cd()
  canvas.Update()
  canvas.SaveAs(output+"/compareHaloJetEnergy.pdf")
  outfile.cd()  
  canvas.Write()  

def MakeCompareHaloJetPhi(inputFile,inputFile2,legend1,legend2,livetime1,livetime2,output):
  ...
  file = rt.TFile(inputFile, "READ")
  h3 = file.Get("halo/hhalojetphi")
  file2 = rt.TFile(inputFile2, "READ")
  h4 = file2.Get("halo/hhalojetphi")
  h4.SetLineColor(2)
  ...
  canvas2.cd()
  canvas2.Update()
  canvas2.SaveAs(output+"/compareHaloJetPhi.pdf")

def MakeCompareHaloJetEta(inputFile,inputFile2,legend1,legend2,livetime1,livetime2,output):
  ...
  file = rt.TFile(inputFile, "READ")
  h5 = file.Get("halo/hhalojeteta")
  file2 = rt.TFile(inputFile2, "READ")
  h6 = file2.Get("halo/hhalojeteta")
  h6.SetLineColor(2)
  ...
  canvas3.cd()
  canvas3.Update()
  canvas3.SaveAs(output+"/compareHaloJetEta.pdf")

def MakeCompareHaloJetEtaPhi(inputFile,inputFile2,legend1,legend2,livetime1,livetime2,output):
  ...
  file = rt.TFile(inputFile, "READ")
  h1 = file.Get("halo/hhalojetetaphi")
  file2 = rt.TFile(inputFile2, "READ")
  h2 = file2.Get("halo/hhalojetetaphi")
  h1.Scale(1.0/float(livetime1))
  h2.Scale(1.0/float(livetime2))
  ...
  #canvas3.cd()
  #canvas3.Update()
  canvas3.SaveAs(output+"/compareHaloJetEtaPhi.pdf")
...
def Main(inputFile,inputFile2,legend1,legend2,livetime1,livetime2,output):
  MakeCompareHaloJetEnergy(inputFile,inputFile2,legend1,legend2,livetime1,livetime2,output)
  MakeCompareHaloJetPhi(inputFile,inputFile2,legend1,legend2,livetime1,livetime2,output)
  MakeCompareHaloJetEta(inputFile,inputFile2,legend1,legend2,livetime1,livetime2,output)
  MakeCompareHaloJetEtaPhi(inputFile,inputFile2,legend1,legend2,livetime1,livetime2,output)
