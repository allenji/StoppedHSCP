...
def MakeCompareCosmicJetEnergy(inputFile,inputFile2,legend1,legend2,livetime1,livetime2,output):
...
#inputFile2 = "/home/weifengji/testV2/processDataAnalysis/CMSSW_7_4_5_ROOT5/src/histos0T/histograms.root"
  ...
  h1 = file.Get("cosmics/hcosjete")
  file2 = rt.TFile(inputFile2, "READ")
  h2 = file2.Get("cosmics/hcosjete")
  h2.SetLineColor(2)
...
def MakeCompareCosmicJetPhi(inputFile,inputFile2,legend1,legend2,livetime1,livetime2,output):
  ...
  file = rt.TFile(inputFile, "READ")
  h3 = file.Get("cosmics/hcosjetphi")
  file2 = rt.TFile(inputFile2, "READ")
  h4 = file2.Get("cosmics/hcosjetphi")
  h4.SetLineColor(2)
  ...
  canvas2.cd()
  canvas2.Update()
  canvas2.SaveAs(output+"/compareCosmicJetPhi.pdf")

def MakeCompareCosmicJetEta(inputFile,inputFile2,legend1,legend2,livetime1,livetime2,output):
  ...
  file = rt.TFile(inputFile, "READ")
  h5 = file.Get("cosmics/hcosjeteta")
  file2 = rt.TFile(inputFile2, "READ")
  h6 = file2.Get("cosmics/hcosjeteta")
  h6.SetLineColor(2)
  ...
  canvas3.cd()
  canvas3.Update()
  canvas3.SaveAs(output+"/compareCosmicJetEta.pdf")

def MakeCompareCosmicJetEtaPhi(inputFile,inputFile2,legend1,legend2,livetime1,livetime2,output):
  ...
  file = rt.TFile(inputFile, "READ")
  h1 = file.Get("cosmics/hcosjetetaphi")
  file2 = rt.TFile(inputFile2, "READ")
  h2 = file2.Get("cosmics/hcosjetetaphi")
  h1.Scale(1.0/float(livetime1))
  h2.Scale(1.0/float(livetime2))
  ...
  #canvas3.cd()
  #canvas3.Update()
  canvas3.SaveAs(output+"/compareCosmicJetEtaPhi.pdf")
...
def Main(inputFile,inputFile2,legend1,legend2,livetime1,livetime2,output):
  MakeCompareCosmicJetEnergy(inputFile,inputFile2,legend1,legend2,livetime1,livetime2,output)
  MakeCompareCosmicJetPhi(inputFile,inputFile2,legend1,legend2,livetime1,livetime2,output)
  MakeCompareCosmicJetEta(inputFile,inputFile2,legend1,legend2,livetime1,livetime2,output)
  MakeCompareCosmicJetEtaPhi(inputFile,inputFile2,legend1,legend2,livetime1,livetime2,output)
